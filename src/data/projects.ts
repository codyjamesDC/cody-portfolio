...
export const projects: Project[] = [
  {
    id: 'medicine-supply-chain',
    title: 'Medicine Supply Chain Intelligence Platform',
    description:
      'A platform for Rural Health Units enabling inventory monitoring, predictive stockout forecasting, and automated requisition planning.',
    bullets: [
      'Built a platform for Rural Health Units enabling inventory monitoring, predictive stockout forecasting, and automated requisition planning.',
      'Developed an EWMA-based demand forecasting engine that calculated medicine consumption velocity, predicted stockout dates, and generated requisition draft recommendations.',
    ],
    event: 'CICS Hackathon',
    period: 'Mar 2026',
    tags: ['Hackathon', 'Fullstack', 'AI'],
